<%@ page
	import="java.util.*,java.net.*,java.sql.*,dbaccess.MyDBAccess,control.Itemfam"
...
for (Itemfam data : itemdata) {
	...
	itemHTML += "<tr><td bgcolor=\"008000\">商品名</td><td>" + data.ItemName + "</td></tr>"
...
<style>
/* iframe 背景の影響を受けないように設定 */
body {
	overflow: hidden;
	background: none;
}

/* 商品画像と詳細情報を横並びにするレイアウト */
.item-layout {
	display: flex;
		...
		<div class="item-layout">
			...
			<div class="item-image">
				<div class="relative">
					...
					for (Itemfam data : itemdata) {
					%>
					<img src="<%=request.getContextPath() + data.img%>" width="150"
						height="150">
					<%
					}
					%>

					<!-- 新商品・近日発売のバッジを条件に応じて表示 -->
					<%
					for (Itemfam data : itemdata) {
					%>
					<%
					...
					%>
					<img src="./view/img/new_image.png" width="120" height="90"
						class="absolute">
					<%
					} else if (data.newItemJudge == 1) {
					%>
					<img src="./view/img/coming_soon.png" width="120" height="90"
						class="absolute">
					<%
					}
					%>
