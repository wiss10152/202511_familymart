...
<div class="center">
	...
	<form name="MyForm" method="POST" action="#" onsubmit="return flag;">
		...
		<div class="button2">
			<input type="submit" class="button" value="商品ランキングへ" onclick="movePrefecture();">
		</div>
	</form>
	...
	<div class="select">
		...
		<form name="f1" action="#" onsubmit="return false">
			<input id="label1" type="radio" name="radio1" onclick="Items(pre,this.cheaked);seatxt.disabled=true;seatxt.value=null;seatxt.placeholder='入力できません'">
				<label for="label1">都道府県検索</label>
			<input id="label2" type="radio" name="radio1" onclick="Connecttext(seatxt,this.cheaked);pre.disabled=true;seatxt.placeholder='店舗名で検索'">
